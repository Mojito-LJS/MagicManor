 ...
 @UIBind('UI/task/TaskReward.ui')
 export default class TaskReward_Generate extends mw.UIScript {
     @UIWidgetBind('RootCanvas/title')
    public title: mw.TextBlock=undefined;
    @UIWidgetBind('RootCanvas/rewardCanvas')
    public rewardCanvas: mw.Canvas=undefined;
