 ...
 @UIBind('UI/sky/SkyItem.ui')
 export default class SkyItem_Generate extends mw.UIScript {
     @UIWidgetBind('RootCanvas/icon')
    public icon: mw.Image=undefined;
    @UIWidgetBind('RootCanvas/selectText')
    public selectText: mw.TextBlock=undefined;
    @UIWidgetBind('RootCanvas/selectIcon')
    public selectIcon: mw.Image=undefined;
    ...
    public btn: mw.Button=undefined;
     ...
     protected initLanguage(){
         //按钮多语言
         //文本多语言
         this.setLanguage(this.selectText)
